...
static result_t build_http_headers(token_t* request_token, const char* method, const char* path, const char* host, size_t content_length) {
...
static result_t send_http_request(int sockfd, const token_t* method_token, const char* path, const char* host, const token_t* body_token) {
