...
__attribute__((warn_unused_result)) result_t json_parse(pool_t* pool, const string_t* json_string, json_value_t** dst);

__attribute__((warn_unused_result)) result_t json_stringify(pool_t* pool, const json_value_t* value, string_t** dst);
...
__attribute__((warn_unused_result)) result_t json_create_bool(pool_t* pool, int bool, json_value_t** dst);

__attribute__((warn_unused_result)) result_t json_create_number(pool_t* pool, double num, json_value_t** dst);

__attribute__((warn_unused_result)) result_t json_create_string(pool_t* pool, const string_t* string, json_value_t** dst);
